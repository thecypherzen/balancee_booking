...
const StationSkeleton = () => {
  return (
    <Skeleton>
      <div className="min-h-[320px] rounded-sm grid shadow-md shadow-primary/5 pb-3 relative bg-white dark:bg-zinc-800 overflow-hidden">
        ...
        <div className="p-4 h-full">
          <div>
            ...
            {/* Book Now Form */}
            <div className="mt-10">
              <div className="bg-secondary dark:bg-zinc-900 gap-2 sp-4 md:p-10 rounded-md flex flex-col gap-4 w-full items-start">
            ...
            {/* map */}
            <div className="w-full mt-10 h-[200px] rounded-md bg-neutral/8 dark:bg-zinc-900/50"></div>
          </div>
        </div>
      </div>
    </Skeleton>
